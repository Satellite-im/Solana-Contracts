...
(async function () {
  ...
  console.log(
    "New FriendInfoFrom account was created and initialized: ",
  ...
  console.log(
    "New FriendInfoTo account was created and initialized: ",
  ...
  let incomingRequestData = await getFriendRequest(
    connection,
