...
ADDRESS_TYPE_INPUT.addVariant(1, BufferLayout.nu64('index'), 'dwellerMemberStatus');
ADDRESS_TYPE_INPUT.addVariant(2, BufferLayout.nu64('index'), 'serverMember');
ADDRESS_TYPE_INPUT.addVariant(3, BufferLayout.nu64('index'), 'serverAdministrator');
